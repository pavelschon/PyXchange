...
MATCHER_DEPS=src/Matcher.cpp src/Matcher.hpp src/Client.hpp src/Trader.hpp src/OrderBook.hpp src/Utils.hpp src/PyXchangeFwd.hpp
...
build/OrderBook.o: $(ORDERBOOK_DEPS)
	$(CXX) $(CXXFLAGS) -o build/OrderBook.o -c src/OrderBook.cpp -I$(PYTHON_INC)
