...
trader1.handleMessageDict(matcher, { 'orderId': 1, 'price': 10, 'quantity': 10, 'message': 'createOrder', 'side': 'BUY' })
trader1.handleMessageDict(matcher, { 'orderId': 2, 'price': 20, 'quantity': 10, 'message': 'createOrder', 'side': 'BUY' })
trader1.handleMessageDict(matcher, { 'orderId': 3, 'price': 30, 'quantity': 10, 'message': 'createOrder', 'side': 'BUY' })

# this order will match with order 3 of trader1 and resting quantity will be inserted to orderbook
trader2.handleMessageDict(matcher, { 'orderId': 1, 'price': 25, 'quantity': 15, 'message': 'createOrder', 'side': 'SELL' })


# this could match with order 1 of trader2, but self-match prevention will reject it
trader2.handleMessageDict(matcher, { 'orderId': 2, 'price': 25, 'quantity': 10, 'message': 'createOrder', 'side': 'BUY' })

trader1.handleMessageDict(matcher, { 'orderId': 2, 'message': 'cancelOrder' })
# order does not exit
trader1.handleMessageDict(matcher, { 'orderId': 2, 'message': 'cancelOrder' })
